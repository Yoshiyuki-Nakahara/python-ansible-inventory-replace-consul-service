...
setup(
    ...
    # this:
    # py_modules=["ansible_dynamic_inventory"],
    ...
    package_data={
        'ansible_dynamic_inventory': ['__version__.txt', 'ansible_dynamic_inventory.ini'],
    },
    ...
    entry_points={
        'console_scripts': [
            'ansible-dynamic-inventory=ansible_dynamic_inventory.cli:main',
        ],
    },
)
